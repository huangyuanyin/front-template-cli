...
'vue3-element-plus': {
    downloadUrl: 'https://gitcode.net/pzy_666/front-project-template/-/raw/master/zip/vue3-element-plus.zip?inline=false',
    desc: 'vue3项目基础模板上整合进element-plus',
},
'vue3-vant': {
    downloadUrl: 'https://gitcode.net/pzy_666/front-project-template/-/raw/master/zip/vue3-vant.zip?inline=false',
    desc: 'vue3项目基础模板上整合进vant(适用移动端项目)',
},
'vitepress-doc': {
    downloadUrl: 'https://gitcode.net/pzy_666/front-project-template/-/raw/master/zip/vitepress-doc.zip?inline=false',
    desc: '用于编写文档的vitepress模板',
},
'vue3-ui-lib':{
    downloadUrl: 'https://gitcode.net/pzy_666/front-project-template/-/raw/master/zip/vue3-ui-lib.zip?inline=false',
